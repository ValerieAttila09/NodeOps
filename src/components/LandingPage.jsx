...
export default function LandingPageComponent() {
  ...
  return (
    <div className="w-full px-4 sm:px-8 md:px-[4rem]">
      ...
      <div className="md:hidden w-full px-2 py-8">
        <h1 className="mb-[calc(8px*1.6)] text-5xl outfit-regular text-neutral-900 text-shadow-xs">
          Liburan Impian Dimulai di <span className="text-shadow-sm bg-clip-text text-5xl text-transparent outfit-semibold bg-gradient-to-r from-blue-500 via-cyan-300 to-sky-500">Travelkakao</span>
        </h1>
        <p className="mb-[calc(16px*1.6)] text-sm text-neutral-600 outfit-regular max-w-6/7">Hanya di Travelkakao Tiket pesawat garansi harga termurah! Jika ada yang lebih murah, kami bayar selisihnya. Plus, dukungan 24 jam untuk perubahan mendadak. <i>Liburan aman, Hati tenang!</i> </p>
        <div className="w-full flex items-center justify-start gap-2">
          <Link to={"/"} className="px-[calc(20px+4px)] py-[calc(8px+2px)] rounded-md flex items-center justify-center overflow-hidden bg-sky-500 hover:bg-blue-600 transition-all">
            <span className="text-white outfit-regular">Pesan Sekarang</span>
          </Link>
          <Link to={"/"} className="p-[2px] rounded-lg overflow-hidden bg-gradient-to-br from-blue-500 via-cyan-400 to-sky-500 group">
            <div className="rounded-md flex items-center gap-2 px-4 group py-2 bg-white group-hover:bg-blue-50 transition-all">
              <span>Cari Tiket Murah</span>
              <ArrowRightIcon className="rotate-[-45deg] group-hover:rotate-[0deg] transition-all" size={20} color="#21acff" />
            </div>
          </Link>
