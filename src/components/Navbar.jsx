  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-1 bg-transparent flex items-center justify-between">
      ...
      <div className="sm:hidden flex items-center gap-2">
        <SignInButton/>
        <button className="ms-1 py-[6px]">
          <svg className="size-6 hover:text-neutral-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
