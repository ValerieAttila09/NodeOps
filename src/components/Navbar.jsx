...
export default function Navbar() {
  ...
  return (
    <div className="w-full sm:px-[4rem] md:px-[6rem] px-4 py-1 bg-blue-50 flex items-center justify-between">
      <div className="flex items-center gap-1">
        ...
        <h1 className="text-lg outfit-regular bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500">Travelkakao</h1>
      </div>
